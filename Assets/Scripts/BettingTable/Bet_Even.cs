...
public class Bet_Even : Bet_Button
{
    ...
    override public void Press()
    {
        ...
        {
            if (bet.bet_even(numbers[i], i))
            {
                final_bet.Add(i);
            }
        }
        bet.add_bet(final_bet, 2, 2);
        if (bet.amount_bets.ContainsKey(2))
        {
            PlaceChips(bet.amount_bets[2]);
        }
        else
        {
