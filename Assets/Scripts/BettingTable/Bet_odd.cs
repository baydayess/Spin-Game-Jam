...
public class Bet_odd : Bet_Button
{
    ...
    override public void Press()
    {
        ...
        {
            if (bet.bet_odd(numbers[i], i))
            {
                final_bet.Add(i);
            }
        }
        bet.add_bet(final_bet, 2, 3);
        if (bet.amount_bets.ContainsKey(3))
        {
            PlaceChips(bet.amount_bets[3]);
        }
        else
        {
